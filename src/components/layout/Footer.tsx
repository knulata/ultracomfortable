...
const paymentMethods = [
  'GoPay', 'OVO', 'DANA', 'ShopeePay', 'QRIS', 'BCA', 'BNI', 'BRI', 'Mandiri'
]
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          ...
          <div className="flex flex-wrap gap-2">
            {paymentMethods.map((method) => (
              <span
                key={method}
                className="px-3 py-1 bg-background rounded text-xs font-medium"
              >
                {method}
              </span>
            ))}
        ...
        <div className="mt-8 pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="#" className="text-muted-foreground hover:text-foreground" aria-label="TikTok">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
