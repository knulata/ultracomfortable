      ...
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          {language === 'id'
            ...
            : 'Thank you for registering as a UC partner. Our team will contact you within 1-2 business days for verification.'
          }
        </p>
        <div className="bg-muted/50 rounded-lg p-4 max-w-sm mx-auto">
          ...
          <ol className="text-sm text-left space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>{language === 'id' ? 'Verifikasi WhatsApp dari tim UC' : 'WhatsApp verification from UC team'}</span>
            </li>
            <li className="flex items-start gap-2">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>{language === 'id' ? 'Mulai drop barang ke gudang UC' : 'Start dropping items at UC warehouse'}</span>
            </li>
          </ol>
        </div>
      </div>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold">
                {language === 'id' ? 'Komisi UC' : 'UC Commission'}
              </span>
            </div>
            <p className="text-sm text-muted-foreground mb-2">
              {language === 'id'
